...
def run():
    ...
    # tengo una lista que transforma lo retornado por map
    # transformar a los diccionarios de data en un diccionario nuevo que es la combinacion del
    # diccionario original con el resultado del nuevo diccionario
    ...
    old_people2 = [{**worker, **{'old': worker['age'] > 70}}
                   for worker in DATA]
